...
std::vector<ChatCommand> ticket_commandscript::GetCommands() const
{
    ...
    static std::vector<ChatCommand> ticketAddonCommandTable =
    {
        ...
        { "cancel",      rbac::RBAC_PERM_COMMAND_TICKET_ADDON,           false,  &AddonHandleGMTicketDelete,                "" },
        { "abandon",     rbac::RBAC_PERM_COMMAND_TICKET_ADDON,           false,  &AddonHandleGMTicketDelete,                "" },
    ...
    static std::vector<ChatCommand> ticketCommandTable =
    {
        ...
        // Compatibility aliases used by some legacy/default ticket UI scripts.
        { "create",         rbac::RBAC_PERM_COMMAND_TICKET,                 false,  &AddonHandleGMTicketCreate,                "" },
        { "update",         rbac::RBAC_PERM_COMMAND_TICKET,                 false,  &AddonHandleGMTicketUpdate,                "" },
        { "append",         rbac::RBAC_PERM_COMMAND_TICKET,                 false,  &AddonHandleGMTicketAppend,                "" },
        { "end",            rbac::RBAC_PERM_COMMAND_TICKET,                 false,  &AddonHandleGMTicketEnd,                   "" },
        { "delete",         rbac::RBAC_PERM_COMMAND_TICKET,                 false,  &AddonHandleGMTicketDelete,                "" },
        { "cancel",         rbac::RBAC_PERM_COMMAND_TICKET,                 false,  &AddonHandleGMTicketDelete,                "" },
        { "abandon",        rbac::RBAC_PERM_COMMAND_TICKET,                 false,  &AddonHandleGMTicketDelete,                "" },
        { "ticketget",      rbac::RBAC_PERM_COMMAND_TICKET,                 false,  &AddonHandleGMTicketGet,                   "" },
        { "ticketres",      rbac::RBAC_PERM_COMMAND_TICKET,                 false,  &AddonHandleGMResponseResolve,             "" },
